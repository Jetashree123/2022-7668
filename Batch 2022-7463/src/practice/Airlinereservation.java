...
public class Airlinereservation {
	...
	public static void main(String args[]) {
		System.out.println("Welcome to the INDIAN RAILWAY reservation system!");
		System.out.println();
	...
	private static void printBoardingPass(int seatnumber) {
		...
		System.out.println("Please be a responsible journ in the journey, do not smoke. Enjoy your trip.");
		System.out.println();
	}
}
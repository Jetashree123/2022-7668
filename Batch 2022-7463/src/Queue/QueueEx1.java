...
but where additionally each element has a "priority" associated with it. In a priority queue, an element with high priority is served before an element with low priority. 
- Wikipedia
...
Input Format
The first line contains an integer, , denoting the total number of events.
...
class QueueEx1 {
	public static void main(String[] args) {
		...
		System.out.println("Enter the value for total event : ");
		...
		PriorityQueue<Student> pQ = new PriorityQueue<Student>(
				...
				new Comparator<Student>() {
					...
					public int compare(Student student1, Student student2) {
						...
						{// step 2 : if CGPA are same sort according to Fname
		...
		for (int i = 0; i < totalEvents; i++) {
			System.out.println("Enter details of the first student  : enter toke as ENTER/SERVED");
            ...
            if (event.equals("ENTER")) {
                ...
                pQ.add(student);	
                //add() throws exception but offer() doesnot. bot methods adds object to queue
            } 
